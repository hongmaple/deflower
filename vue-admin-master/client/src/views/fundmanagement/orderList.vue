      ...
      <div class="staff">
        <div class="staff-top">
          <div class="search-box">
            <el-form :inline="true" ref="search_data" :rules="rules" :model="search_data">
        ...
        <div class="tables">
          <el-table :data="flowerData.list" border style="width: 100%">
            <el-table-column label="订单id" align="center" width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.orderId }}</span>
              </template>
            </el-table-column>
            <el-table-column label="实际金额" align="center" width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.actualPay }}</span>
              </template>
            </el-table-column>
            <el-table-column label="总金额" align="center" width="180">
              <template slot-scope="scope">
            ...
            <el-table-column label="收货地址" align="center" width="180">
              <template slot-scope="scope">
                <span
                  style="margin-left: 10px">{{ scope.row.receiverState }}{{ scope.row.receiverCity }}{{ scope.row.receiverDistrict }}{{ scope.row.receiverAddress }}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column label="付款人" align="center" width="180">
              <template slot-scope="scope">
        ...
        <div class="page">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
            :current-page="flowerData.pageNum" :page-sizes="flowerData.page_sizes" :page-size="flowerData.pageSize"
            :layout="flowerData.layout" :total="flowerData.total">
          </el-pagination>
        </div>
      </div>
    </el-tab-pane>
      ...
      <div class="staff">
        ...
        <div class="tables">
          <el-table :data="flowerData.list" border style="width: 100%">
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-button size="mini" @click="shipments(scope.row.orderId)">发货</el-button>
                <el-popover placement="right" width="800" trigger="click">
                  <el-table :data="scope.row.orderDetails">
                    <el-table-column width="150" label="图片">
                      <template slot-scope="setails">
...
export default {
  ...
  methods: {
    flowerList(formData) {
      this.$axios
        .post("/api/order/user/list", formData, {
