...
<view class="container">
  ...
  <view class="content">
    ...
    <view class="cat-item">
      <view class="item" @tap="toClassifyPage" data-sts="1" data-title="优雅绿植" :data-id="4" >
        <image src="/static/images/icon/newProd.png"></image>
        <text>优雅绿植</text>
      </view>
      <view class="item" @tap="toClassifyPage" data-sts="2" data-title="浪漫鲜花" :data-id="1" >
        <image src="/static/images/icon/timePrice.png"></image>
        <text>浪漫鲜花</text>
      </view>
      <view class="item" @tap="toClassifyPage" data-sts="3" data-title="一枝独秀" :data-id="6" >
        <image src="/static/images/icon/neweveryday.png"></image>
        <text>一枝独秀</text>
      </view>
      <view class="item" @tap="toClassifyPage" data-sts="4"  data-title="心动时刻" :data-id="7">
    ...
    <view class="message-play" @tap="onNewsPage">
      ...
      <!--  <block v-for="(item, index) in news" :key="index">
		...
		<swiper-item class="items"><a href="pages/articles/articles" style="text-decoration:none;color:#000000">送花的常识和技巧</a></swiper-item>
		<swiper-item class="items"><a href="pages/articles/articles" style="text-decoration:none;color:#000000">三月吃花才潮！</a></swiper-item>
		<swiper-item class="items"><a href="pages/articles/articles" style="text-decoration:none;color:#000000">没有确定恋爱关系，送什么花？</a></swiper-item>
		<swiper-item class="items"><a href="pages/articles/articles" style="text-decoration:none;color:#000000">鲜花寓意 浪漫花语</a></swiper-item>
      </swiper>
