...
<view class="container">
  <view class="submit-order">
    ...
    <view class="delivery-addr " @tap="toAddrListPage">
      <view class="addr-bg " v-if="userAddr.id==0">
        <view class="add-addr">
      ...
      <view class="addr-bg whole" v-if="userAddr.id>0">
...
export default {
   ...
   */
  onShow: function () {
      console.log(JSON.stringify(this.userAddr));
      if (this.addrId>0) {
        uni.showLoading();
        var params = {
          url: "/address/" + this.addrId,
          method: "GET",
      	  needToken: true,
          data: {},
          callBack: res => {
